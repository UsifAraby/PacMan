...
void Ghost::moveRandom(int pix) {
    ...
    static mt19937 rng(random_device{}());  // Mersenne twister algorithm
    ...
    if (timer.getElapsedTime().asSeconds() > 0.2) {
        ...
        cout << lastDirection << "ccccccccccccccccc" << endl;
...
{
    if (getDirection() == "none") // ghost mesh moving
    {
        setDirection(dir);

    }
    else // ghost beymoving
    {
